...
class OwnAdAdapter(
        private val listmyAd: MutableList<AdList>,
        private val context: Context

): RecyclerView.Adapter<OwnAdAdapter.AdViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OwnAdAdapter.AdViewHolder {
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.smalladdesign,parent,false)
        return OwnAdAdapter.AdViewHolder(view)
    }

    override fun onBindViewHolder(holder: OwnAdAdapter.AdViewHolder, position: Int) {
        val ad = listmyAd[position]
            ...
            builder.setPositiveButton("Yes"){dialogInterface, which ->
                    CoroutineScope(Dispatchers.IO).launch {
                        try {
                            ...
                            val response = adRepository.deletead(ad._id)
